...
# 309 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 2
# 376 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
...
# 469 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Init(I2C_HandleTypeDef *hi2c)
{

  if (hi2c == 
# 472 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
             ((void *)0)
# 472 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                 )
  {
    return HAL_ERROR;
  }
...
HAL_StatusTypeDef HAL_I2C_DeInit(I2C_HandleTypeDef *hi2c)
{
  ...
  if (hi2c == 
# 581 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
             ((void *)0)
# 581 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                 )
  {
    return HAL_ERROR;
  }
...
HAL_StatusTypeDef HAL_I2C_Master_Transmit(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    hi2c->XferCount = Size;
    hi2c->XferISR = 
# 1084 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                     ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Master_Receive(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    hi2c->XferCount = Size;
    hi2c->XferISR = 
# 1198 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                     ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Slave_Transmit(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  {
    if ((pData == 
# 1293 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
# 1293 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    hi2c->XferCount = Size;
    hi2c->XferISR = 
# 1311 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                     ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Slave_Receive(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  {
    if ((pData == 
# 1430 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
# 1430 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    hi2c->XferCount = Size;
    hi2c->XferISR = 
# 1448 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                     ((void *)0)
...
# 1686 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Slave_Transmit_IT(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size)
{
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
...
# 1735 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Slave_Receive_IT(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size)
{
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
...
HAL_StatusTypeDef HAL_I2C_Master_Transmit_DMA(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    {
      if (hi2c->hdmatx != 
# 1824 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                         ((void *)0)
...
# 1833 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                            ((void *)0)
# 1833 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                                                ;
        hi2c->hdmatx->XferAbortCallback = 
# 1834 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                         ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Master_Receive_DMA(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    {
      if (hi2c->hdmarx != 
# 1967 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                         ((void *)0)
...
# 1976 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                            ((void *)0)
# 1976 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                                                ;
        hi2c->hdmarx->XferAbortCallback = 
# 1977 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                         ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Slave_Transmit_DMA(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size)
{
  ...
  {
    if ((pData == 
# 2076 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
# 2076 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    if (hi2c->hdmatx != 
# 2095 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                       ((void *)0)
# 2095 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                           )
    {
      ...
      hi2c->hdmatx->XferHalfCpltCallback = 
# 2104 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                          ((void *)0)
# 2104 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                                              ;
      hi2c->hdmatx->XferAbortCallback = 
# 2105 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                       ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Slave_Receive_DMA(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size)
{
  ...
  {
    if ((pData == 
# 2179 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
# 2179 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    if (hi2c->hdmarx != 
# 2198 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                       ((void *)0)
# 2198 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                           )
    {
      ...
      hi2c->hdmarx->XferHalfCpltCallback = 
# 2207 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                          ((void *)0)
# 2207 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                                              ;
      hi2c->hdmarx->XferAbortCallback = 
# 2208 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                       ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Mem_Write(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  {
    if ((pData == 
# 2289 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
# 2289 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    hi2c->XferCount = Size;
    hi2c->XferISR = 
# 2313 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                     ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Mem_Read(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  {
    if ((pData == 
# 2424 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
# 2424 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    hi2c->XferCount = Size;
    hi2c->XferISR = 
# 2448 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                     ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Mem_Write_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint8_t *pData, uint16_t Size)
{
  ...
  {
    if ((pData == 
# 2558 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Mem_Read_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint8_t *pData, uint16_t Size)
{
  ...
  {
    if ((pData == 
# 2649 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Mem_Write_DMA(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint8_t *pData, uint16_t Size)
{
  ...
  {
    if ((pData == 
# 2740 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
# 2740 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    if (hi2c->hdmatx != 
# 2787 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                       ((void *)0)
# 2787 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                           )
    {
      ...
      hi2c->hdmatx->XferHalfCpltCallback = 
# 2796 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                          ((void *)0)
# 2796 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                                              ;
      hi2c->hdmatx->XferAbortCallback = 
# 2797 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                       ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Mem_Read_DMA(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint8_t *pData, uint16_t Size)
{
  ...
  {
    if ((pData == 
# 2884 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
# 2884 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    if (hi2c->hdmarx != 
# 2930 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                       ((void *)0)
# 2930 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                           )
    {
      ...
      hi2c->hdmarx->XferHalfCpltCallback = 
# 2939 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                          ((void *)0)
# 2939 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                                              ;
      hi2c->hdmarx->XferAbortCallback = 
# 2940 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                       ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Master_Seq_Transmit_DMA(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t XferOptions)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    {
      if (hi2c->hdmatx != 
# 3296 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                         ((void *)0)
# 3296 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                             )
      {
        ...
        hi2c->hdmatx->XferHalfCpltCallback = 
# 3305 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                            ((void *)0)
# 3305 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                                                ;
        hi2c->hdmatx->XferAbortCallback = 
# 3306 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                         ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Master_Seq_Receive_DMA(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t XferOptions)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    {
      if (hi2c->hdmarx != 
# 3542 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                         ((void *)0)
# 3542 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                             )
      {
        ...
        hi2c->hdmarx->XferHalfCpltCallback = 
# 3551 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                            ((void *)0)
# 3551 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                                                ;
        hi2c->hdmarx->XferAbortCallback = 
# 3552 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                         ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Slave_Seq_Transmit_IT(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size, uint32_t XferOptions)
{
  ...
  {
    if ((pData == 
# 3653 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
# 3653 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    if (hi2c->State == HAL_I2C_STATE_BUSY_RX_LISTEN)
    {
      ...
      if ((hi2c->Instance->CR1 & (0x1UL << (15U))) == (0x1UL << (15U)))
      {
        ...
        if (hi2c->hdmarx != 
# 3677 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                           ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Slave_Seq_Transmit_DMA(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size, uint32_t XferOptions)
{
  ...
  {
    if ((pData == 
# 3750 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
# 3750 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    if (hi2c->State == HAL_I2C_STATE_BUSY_RX_LISTEN)
    {
      ...
      if ((hi2c->Instance->CR1 & (0x1UL << (15U))) == (0x1UL << (15U)))
      {
        ...
        if (hi2c->hdmarx != 
# 3772 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                           ((void *)0)
# 3772 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    else if (hi2c->State == HAL_I2C_STATE_BUSY_TX_LISTEN)
    {
      if ((hi2c->Instance->CR1 & (0x1UL << (14U))) == (0x1UL << (14U)))
      {
        ...
        if (hi2c->hdmatx != 
# 3796 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                           ((void *)0)
# 3796 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    if (hi2c->hdmatx != 
# 3830 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                       ((void *)0)
# 3830 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                           )
    {
      ...
      hi2c->hdmatx->XferHalfCpltCallback = 
# 3839 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                          ((void *)0)
# 3839 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                                              ;
      hi2c->hdmatx->XferAbortCallback = 
# 3840 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                       ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_Slave_Seq_Receive_IT(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size, uint32_t XferOptions)
{
  ...
  {
    if ((pData == 
# 3927 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
# 3927 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    if (hi2c->State == HAL_I2C_STATE_BUSY_TX_LISTEN)
    {
      ...
      if ((hi2c->Instance->CR1 & (0x1UL << (14U))) == (0x1UL << (14U)))
      {
        ...
        if (hi2c->hdmatx != 
# 3951 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                           ((void *)0)
# 3951 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                               )
        {
...
HAL_StatusTypeDef HAL_I2C_Slave_Seq_Receive_DMA(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size, uint32_t XferOptions)
{
  ...
  {
    if ((pData == 
# 4024 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
# 4024 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    if (hi2c->State == HAL_I2C_STATE_BUSY_TX_LISTEN)
    {
      ...
      if ((hi2c->Instance->CR1 & (0x1UL << (14U))) == (0x1UL << (14U)))
      {
        ...
        if (hi2c->hdmatx != 
# 4046 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                           ((void *)0)
# 4046 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    else if (hi2c->State == HAL_I2C_STATE_BUSY_RX_LISTEN)
    {
      if ((hi2c->Instance->CR1 & (0x1UL << (15U))) == (0x1UL << (15U)))
      {
        ...
        if (hi2c->hdmarx != 
# 4070 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                           ((void *)0)
# 4070 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
    ...
    if (hi2c->hdmarx != 
# 4104 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                       ((void *)0)
# 4104 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                           )
    {
      ...
      hi2c->hdmarx->XferHalfCpltCallback = 
# 4113 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                          ((void *)0)
# 4113 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                                              ;
      hi2c->hdmarx->XferAbortCallback = 
# 4114 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                       ((void *)0)
...
HAL_StatusTypeDef HAL_I2C_DisableListen_IT(I2C_HandleTypeDef *hi2c)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_LISTEN)
  {
    ...
    hi2c->Mode = HAL_I2C_MODE_NONE;
    hi2c->XferISR = 
# 4226 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                   ((void *)0)
...
void HAL_I2C_EV_IRQHandler(I2C_HandleTypeDef *hi2c)
{
  ...
  if (hi2c->XferISR != 
# 4304 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                      ((void *)0)
...
static HAL_StatusTypeDef I2C_Slave_ISR_DMA(struct __I2C_HandleTypeDef *hi2c, uint32_t ITFlags, uint32_t ITSources)
{
  ...
  if ((((((ITFlags) & (((0x1UL << (4U))) & (0x0001FFFFU))) == (((0x1UL << (4U))) & (0x0001FFFFU))) ? SET : RESET) != RESET) && (((((ITSources) & ((0x1UL << (4U)))) == ((0x1UL << (4U)))) ? SET : RESET) != RESET))
  {
        ...
        (((((ITSources) & ((0x1UL << (15U)))) == ((0x1UL << (15U)))) ? SET : RESET) != RESET))
    {
      ...
      if (hi2c->hdmarx != 
# 5025 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                         ((void *)0)
# 5025 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
      ...
      if (hi2c->hdmatx != 
# 5037 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                         ((void *)0)
...
static void I2C_ITMasterSeqCplt(I2C_HandleTypeDef *hi2c)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_BUSY_TX)
  {
    ...
    hi2c->XferISR = 
# 5328 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                         ((void *)0)
# 5328 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
  ...
  else
  {
    ...
    hi2c->XferISR = 
# 5348 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                         ((void *)0)
...
static void I2C_ITMasterCplt(I2C_HandleTypeDef *hi2c, uint32_t ITFlags)
{
  ...
  hi2c->PreviousState = ((uint32_t)(HAL_I2C_MODE_NONE));
  hi2c->XferISR = 
# 5438 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                       ((void *)0)
...
static void I2C_ITSlaveCplt(I2C_HandleTypeDef *hi2c, uint32_t ITFlags)
{
  ...
  {
    if (hi2c->hdmatx != 
# 5568 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                       ((void *)0)
# 5568 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
  ...
  {
    if (hi2c->hdmarx != 
# 5575 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                       ((void *)0)
# 5575 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
  ...
  hi2c->Mode = HAL_I2C_MODE_NONE;
  hi2c->XferISR = 
# 5613 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
...
static void I2C_ITListenCplt(I2C_HandleTypeDef *hi2c, uint32_t ITFlags)
{
  ...
  hi2c->Mode = HAL_I2C_MODE_NONE;
  hi2c->XferISR = 
# 5689 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                 ((void *)0)
...
static void I2C_ITError(I2C_HandleTypeDef *hi2c, uint32_t ErrorCode)
{
  ...
  else
  {
    ...
    hi2c->PreviousState = ((uint32_t)(HAL_I2C_MODE_NONE));
    hi2c->XferISR = 
# 5771 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                         ((void *)0)
# 5771 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
  ...
  if ((hi2c->Instance->CR1 & (0x1UL << (14U))) == (0x1UL << (14U)))
  {
    ...
    if (hi2c->hdmatx != 
# 5779 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                       ((void *)0)
# 5779 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
  ...
  else if ((hi2c->Instance->CR1 & (0x1UL << (15U))) == (0x1UL << (15U)))
  {
    ...
    if (hi2c->hdmarx != 
# 5801 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                       ((void *)0)
...
static void I2C_DMAAbort(DMA_HandleTypeDef *hdma)
{
  ...
  hi2c->hdmatx->XferAbortCallback = 
# 6044 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                   ((void *)0)
# 6044 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c"
                                       ;
  hi2c->hdmarx->XferAbortCallback = 
# 6045 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_i2c.c" 3 4
                                   ((void *)0)
