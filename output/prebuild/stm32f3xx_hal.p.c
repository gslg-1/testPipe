...
# 37 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal.c" 2
# 76 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal.c"
...
# 278 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal.c"
...
uint32_t HAL_GetHalVersion(void)
{
 return (((0x01U) << 24U) |((0x05U) << 16U) |((0x03U) << 8U ) |((0x00U)));
}
...
uint32_t HAL_GetUIDw1(void)
{
   return(((*((uint32_t *)(0x1FFFF7ACUL + 4U)))));
}
...
uint32_t HAL_GetUIDw2(void)
{
   return(((*((uint32_t *)(0x1FFFF7ACUL + 8U)))));
}
