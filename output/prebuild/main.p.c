...
# 23 "Src/main.c" 2
# 1 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h" 1
# 146 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
# 1 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os2.h" 1
# 43 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os2.h"
# 1 "d:\\tool_chain\\gcc-arm-none-eabi\\5.4 2016q3\\lib\\gcc\\arm-none-eabi\\5.4.1\\include\\stddef.h" 1 3 4
...
# 147 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h" 2
...
# 148 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h" 2
# 175 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
typedef void (*os_pthread) (void const *argument);


typedef void (*os_ptimer) (void const *argument);
# 213 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
typedef int32_t osStatus;
# 257 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
# 275 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
typedef struct os_thread_def {
  os_pthread pthread;
  osThreadAttr_t attr;
} osThreadDef_t;
# 287 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
typedef struct os_timer_def {
  os_ptimer ptimer;
  osTimerAttr_t attr;
} osTimerDef_t;
# 319 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
typedef struct os_pool_def {
  uint32_t pool_sz;
  uint32_t item_sz;
  osMemoryPoolAttr_t attr;
} osPoolDef_t;
# 333 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
typedef struct os_messageQ_def {
  uint32_t queue_sz;
  osMessageQueueAttr_t attr;
} osMessageQDef_t;
# 347 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
# 453 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
osThreadId_t osThreadCreate (const osThreadDef_t *thread_def, void *argument);
# 496 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
# 555 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
osTimerId_t osTimerCreate (const osTimerDef_t *timer_def, osTimerType_t type, void *argument);
# 602 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
osMutexId_t osMutexCreate (const osMutexAttr_t *mutex_def);
# 654 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
# 755 "Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
# 140 "Src/main.c"
  ...
  blinkLEDTaskHandle = osThreadNew(StartTask02, 
# 143 "Src/main.c" 3 4
                                               ((void *)0)
# 143 "Src/main.c"
  ...
  comUSBTaskHandle = osThreadNew(StartComUSBTask, 
# 147 "Src/main.c" 3 4
                                                 ((void *)0)
# 147 "Src/main.c"
                                                     , &comUSBTask_attributes);
...
void SystemClock_Config(void)
{
  ...
  RCC_OscInitStruct.PLL.PLLMUL = (0x00380000U);
...
static void MX_GPIO_Init(void)
{
  ...
  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00001000UL))->AHBENR) |= ((0x1UL << (19U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00001000UL))->AHBENR) & ((0x1UL << (19U)))); (void)tmpreg; } while(0U);
  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00001000UL))->AHBENR) |= ((0x1UL << (22U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00001000UL))->AHBENR) & ((0x1UL << (22U)))); (void)tmpreg; } while(0U);
  ...
  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00001000UL))->AHBENR) |= ((0x1UL << (18U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00001000UL))->AHBENR) & ((0x1UL << (18U)))); (void)tmpreg; } while(0U);


  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x08000000UL) + 0x00000400UL)), ((uint16_t)0x2000U), GPIO_PIN_RESET);


  GPIO_InitStruct.Pin = ((uint16_t)0x2000U);
  GPIO_InitStruct.Mode = (0x10210000U);
  GPIO_InitStruct.Pull = (0x00000000U);
  HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x08000000UL) + 0x00000800UL)), &GPIO_InitStruct);
  ...
  HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x08000000UL) + 0x00000400UL)), &GPIO_InitStruct);
...
void StartTask02(void *argument)
{
  ...
  for(;;)
  {
    HAL_GPIO_TogglePin(((GPIO_TypeDef *) ((0x40000000UL + 0x08000000UL) + 0x00000400UL)),((uint16_t)0x2000U));
    osDelay(200);
  }
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  if (htim->Instance == ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00002C00UL))) {
    HAL_IncTick();
  }
