...
# 1 "<command-line>"
# 1 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_gpio.c"
# 106 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_gpio.c"
...
# 107 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_gpio.c" 2
# 179 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_gpio.c"
void HAL_GPIO_Init(GPIO_TypeDef *GPIOx, GPIO_InitTypeDef *GPIO_Init)
{
  ...
  while (((GPIO_Init->Pin) >> position) != 0x00u)
  {
    ...
    if (iocurrent != 0x00u)
    {
      ...
      if((GPIO_Init->Mode & (0x10000000U)) == (0x10000000U))
      {
        ...
        temp = ((SYSCFG_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000000UL))->EXTICR[position >> 2u];
        temp &= ~(0x0FuL << (4u * (position & 0x03u)));
        temp |= ((((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x08000000UL) + 0x00000000UL))))? 0U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x08000000UL) + 0x00000400UL))))? 1U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x08000000UL) + 0x00000800UL))))? 2U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x08000000UL) + 0x00000C00UL))))? 3U : 5U) << (4u * (position & 0x03u)));
        ((SYSCFG_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000000UL))->EXTICR[position >> 2u] = temp;


        temp = ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->IMR;
        temp &= ~(iocurrent);
        if((GPIO_Init->Mode & (0x00010000U)) == (0x00010000U))
        {
          temp |= iocurrent;
        }
        ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->IMR = temp;

        temp = ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->EMR;
        temp &= ~(iocurrent);
        if((GPIO_Init->Mode & (0x00020000U)) == (0x00020000U))
        {
          temp |= iocurrent;
        }
        ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->EMR = temp;


        temp = ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->RTSR;
        temp &= ~(iocurrent);
        if((GPIO_Init->Mode & (0x00100000U)) == (0x00100000U))
        {
          temp |= iocurrent;
        }
        ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->RTSR = temp;

        temp = ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->FTSR;
        temp &= ~(iocurrent);
        if((GPIO_Init->Mode & (0x00200000U)) == (0x00200000U))
        {
          temp |= iocurrent;
        }
        ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->FTSR = temp;
      }
    }
...
# 304 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_gpio.c"
void HAL_GPIO_DeInit(GPIO_TypeDef *GPIOx, uint32_t GPIO_Pin)
{
  uint32_t position = 0x00u;
  uint32_t iocurrent;
  ...
  while ((GPIO_Pin >> position) != 0x00u)
  {
    ...
    if (iocurrent != 0x00u)
    {
      ...
      tmp = ((SYSCFG_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000000UL))->EXTICR[position >> 2u];
      tmp &= (0x0FuL << (4u * (position & 0x03u)));
      if (tmp == ((((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x08000000UL) + 0x00000000UL))))? 0U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x08000000UL) + 0x00000400UL))))? 1U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x08000000UL) + 0x00000800UL))))? 2U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x08000000UL) + 0x00000C00UL))))? 3U : 5U) << (4u * (position & 0x03u))))
      {
        ...
        tmp = 0x0FuL << (4u * (position & 0x03u));
        ((SYSCFG_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000000UL))->EXTICR[position >> 2u] &= ~tmp;
      }
...
# 420 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_gpio.c"
void HAL_GPIO_WritePin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, GPIO_PinState PinState)
{
...
# 468 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_gpio.c"
HAL_StatusTypeDef HAL_GPIO_LockPin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
