...
# 44 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_flash_ex.c" 2
      ...
      if (FLASH_WaitForLastOperation((uint32_t)(50000U)) == HAL_OK)
      {
        ...
        *PageError = 0xFFFFFFFFU;
        ...
        for(address = pEraseInit->PageAddress;
            address < ((pEraseInit->NbPages * 0x800) + pEraseInit->PageAddress);
            address += 0x800)
        {
...
uint32_t HAL_FLASHEx_OBGetUserData(uint32_t DATAAdress)
{
  ...
  if (DATAAdress == (0x1FFFF804U))
  {
    ...
    value = ((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00002000UL))->OBR) & ((0xFFUL << (16U)))) >> (uint32_t)((uint8_t)__builtin_clz(__RBIT((0xFFUL << (16U)))));
  }
  else
  {

    value = ((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00002000UL))->OBR) & ((0xFFUL << (24U)))) >> (uint32_t)((uint8_t)__builtin_clz(__RBIT((0xFFUL << (24U)))));
  }
...
# 521 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_EnableWRP(uint32_t WriteProtectPage)
{
  HAL_StatusTypeDef status = HAL_OK;
...
static uint32_t FLASH_OB_GetRDP(void)
{
  ...
  tmp_reg = ((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00002000UL))->OBR) & ((0x3UL << (1U))));
  ...
  {
    return ((uint8_t)0xCCU);
  }
  else if (tmp_reg == 0U)
  {
    return ((uint8_t)0xAAU);
  }
  else
  {
    return ((uint8_t)0xBBU);
  }
}
...
static uint8_t FLASH_OB_GetUser(void)
{
  ...
  return (uint8_t)((((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00002000UL))->OBR)) & (0x77UL << (8U))) >> (uint32_t)((uint8_t)__builtin_clz(__RBIT((0x1UL << (8U))))));
}
