...
# 110 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_cortex.c" 2
...
# 191 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_cortex.c"
void HAL_NVIC_SetPriority(IRQn_Type IRQn, uint32_t PreemptPriority, uint32_t SubPriority)
{
...
# 213 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_cortex.c"
void HAL_NVIC_EnableIRQ(IRQn_Type IRQn)
{
...
# 229 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_cortex.c"
void HAL_NVIC_DisableIRQ(IRQn_Type IRQn)
{
...
# 255 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_cortex.c"
uint32_t HAL_SYSTICK_Config(uint32_t TicksNumb)
{
...
# 391 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_cortex.c"
void HAL_NVIC_GetPriority(IRQn_Type IRQn, uint32_t PriorityGroup, uint32_t* pPreemptPriority, uint32_t* pSubPriority)
{
...
# 406 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_cortex.c"
void HAL_NVIC_SetPendingIRQ(IRQn_Type IRQn)
{

  __NVIC_SetPendingIRQ(IRQn);
}
# 421 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_cortex.c"
uint32_t HAL_NVIC_GetPendingIRQ(IRQn_Type IRQn)
{

  return __NVIC_GetPendingIRQ(IRQn);
}
# 434 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_cortex.c"
void HAL_NVIC_ClearPendingIRQ(IRQn_Type IRQn)
{

  __NVIC_ClearPendingIRQ(IRQn);
}
# 448 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_cortex.c"
uint32_t HAL_NVIC_GetActive(IRQn_Type IRQn)
{

  return __NVIC_GetActive(IRQn);
}
# 462 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_cortex.c"
void HAL_SYSTICK_CLKSourceConfig(uint32_t CLKSource)
{
