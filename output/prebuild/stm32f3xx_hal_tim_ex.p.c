...
# 81 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c" 2
# 98 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c"
static void TIM_CCxNChannelCmd(TIM_TypeDef *TIMx, uint32_t Channel, uint32_t ChannelNState);
# 132 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_HallSensor_Init(TIM_HandleTypeDef *htim, TIM_HallSensor_InitTypeDef *sConfig)
{
  ...
  if (htim == 
# 137 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c" 3 4
             ((void *)0)
# 137 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c"
                 )
  {
    return HAL_ERROR;
  }
...
# 168 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c"
  ...
  OC_Config.OCMode = ((0x00000040U) | (0x00000020U) | (0x00000010U));
...
# 545 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_OCN_Stop(TIM_HandleTypeDef *htim, uint32_t Channel)
{
...
# 640 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_OCN_Stop_IT(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  uint32_t tmpccer;
...
# 706 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_OCN_Start_DMA(TIM_HandleTypeDef *htim, uint32_t Channel, uint32_t *pData, uint16_t Length)
{
  uint32_t tmpsmcr;
...
# 824 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_OCN_Stop_DMA(TIM_HandleTypeDef *htim, uint32_t Channel)
{
...
# 1399 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_OnePulseN_Stop_IT(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
{
...
# 1583 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_ConfigCommutEvent_DMA(TIM_HandleTypeDef *htim, uint32_t InputTrigger,
                                                  uint32_t CommutationSource)
{
...
# 1632 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_MasterConfigSynchronization(TIM_HandleTypeDef *htim,
                                                        TIM_MasterConfigTypeDef *sMasterConfig)
{
  uint32_t tmpcr2;
  ...
  if ((((htim->Instance) == ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00002C00UL))) || ((htim->Instance) == ((TIM_TypeDef *) (0x40000000UL + 0x00000000UL))) || ((htim->Instance) == ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00004000UL)))))
  {
...
# 1707 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_ConfigBreakDeadTime(TIM_HandleTypeDef *htim,
                                                TIM_BreakDeadTimeConfigTypeDef *sBreakDeadTimeConfig)
{
...
# 1852 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_RemapConfig(TIM_HandleTypeDef *htim, uint32_t Remap)
{
  do{ if((htim)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (htim)->Lock = HAL_LOCKED; } }while (0U);
...
# 2078 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_tim_ex.c"
static void TIM_CCxNChannelCmd(TIM_TypeDef *TIMx, uint32_t Channel, uint32_t ChannelNState)
{
  uint32_t tmp;
