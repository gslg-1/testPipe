...
# 79 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 2
...
HAL_StatusTypeDef HAL_DMA_Init(DMA_HandleTypeDef *hdma)
{
  ...
  if(
# 142 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
    ((void *)0) 
...
HAL_StatusTypeDef HAL_DMA_DeInit(DMA_HandleTypeDef *hdma)
{
  ...
  if(
# 202 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
    ((void *)0) 
# 202 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c"
  ...
  hdma->DmaBaseAddress->IFCR = (0x00000001U) << hdma->ChannelIndex;


  hdma->XferCpltCallback = 
# 232 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                          ((void *)0)
# 232 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c"
                              ;
  hdma->XferHalfCpltCallback = 
# 233 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                              ((void *)0)
# 233 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c"
                                  ;
  hdma->XferErrorCallback = 
# 234 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                           ((void *)0)
# 234 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c"
                               ;
  hdma->XferAbortCallback = 
# 235 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                           ((void *)0)
 ...
 HAL_StatusTypeDef status = HAL_OK;
  ...
  if(HAL_DMA_STATE_READY == hdma->State)
  {
   ...
   DMA_SetConfig(hdma, SrcAddress, DstAddress, DataLength);
    ...
    if(
# 353 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
      ((void *)0) 
...
# 452 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                                 ((void *)0)
...
HAL_StatusTypeDef HAL_DMA_PollForTransfer(DMA_HandleTypeDef *hdma, uint32_t CompleteLevel, uint32_t Timeout)
{
  ...
  if(HAL_DMA_FULL_TRANSFER == CompleteLevel)
  {
    ...
    temp = (0x00000002U) << hdma->ChannelIndex;
  }
  else
  {

    temp = (0x00000004U) << hdma->ChannelIndex;
  }
  ...
  {
    if(RESET != (hdma->DmaBaseAddress->ISR & ((0x00000008U) << hdma->ChannelIndex)))
    {
  ...
  if(HAL_DMA_FULL_TRANSFER == CompleteLevel)
  {
    ...
    hdma->DmaBaseAddress->IFCR = (0x00000002U) << hdma->ChannelIndex;
  ...
  else
  {
    ...
    hdma->DmaBaseAddress->IFCR = (0x00000004U) << hdma->ChannelIndex;
  }
...
void HAL_DMA_IRQHandler(DMA_HandleTypeDef *hdma)
{
 uint32_t flag_it = hdma->DmaBaseAddress->ISR;
  ...
  if ((RESET != (flag_it & ((0x00000004U) << hdma->ChannelIndex))) && (RESET != (source_it & ((uint32_t)(0x1UL << (2U))))))
  {
...
# 590 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                                   ((void *)0)
# 590 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c"
  ...
  else if ((RESET != (flag_it & ((0x00000002U) << hdma->ChannelIndex))) && (RESET != (source_it & ((uint32_t)(0x1UL << (1U))))))
  {
   if((hdma->Instance->CCR & (0x1UL << (5U))) == 0U)
   {
...
# 616 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                               ((void *)0)
...
# 643 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                                 ((void *)0)
...
HAL_StatusTypeDef HAL_DMA_UnRegisterCallback(DMA_HandleTypeDef *hdma, HAL_DMA_CallbackIDTypeDef CallbackID)
{
  ...
  if(HAL_DMA_STATE_READY == hdma->State)
  {
    switch (CallbackID)
    {
     case HAL_DMA_XFER_CPLT_CB_ID:
           hdma->XferCpltCallback = 
# 724 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                                   ((void *)0)
# 724 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c"
     ...
     case HAL_DMA_XFER_HALFCPLT_CB_ID:
           hdma->XferHalfCpltCallback = 
# 728 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                                       ((void *)0)
# 728 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c"
     ...
     case HAL_DMA_XFER_ERROR_CB_ID:
           hdma->XferErrorCallback = 
# 732 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                                    ((void *)0)
# 732 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c"
     ...
     case HAL_DMA_XFER_ABORT_CB_ID:
           hdma->XferAbortCallback = 
# 736 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                                    ((void *)0)
# 736 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c"
    ...
    case HAL_DMA_XFER_ALL_CB_ID:
           hdma->XferCpltCallback = 
# 740 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                                   ((void *)0)
# 740 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c"
                                       ;
           hdma->XferHalfCpltCallback = 
# 741 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                                       ((void *)0)
# 741 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c"
                                           ;
           hdma->XferErrorCallback = 
# 742 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                                    ((void *)0)
# 742 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c"
                                        ;
           hdma->XferAbortCallback = 
# 743 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c" 3 4
                                    ((void *)0)
...
# 878 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_dma.c"
  hdma->ChannelIndex = (((uint32_t)hdma->Instance - (uint32_t)((DMA_Channel_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00000008UL))) / ((uint32_t)((DMA_Channel_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000001CUL)) - (uint32_t)((DMA_Channel_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00000008UL)))) << 2U;
