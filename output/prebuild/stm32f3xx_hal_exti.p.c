...
# 88 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_exti.c" 2
...
HAL_StatusTypeDef HAL_EXTI_SetConfigLine(EXTI_HandleTypeDef *hexti, EXTI_ConfigTypeDef *pExtiConfig)
{
  ...
  if ((hexti == 
# 153 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_exti.c" 3 4
               ((void *)0)
...
# 153 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_exti.c"
  ...
  if ((pExtiConfig->Line & (0x02uL << 24u)) != 0x00u)
  {
    ...
    regaddr = (&((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->RTSR + (0x08u * offset));
    regval = *regaddr;
    ...
    *regaddr = regval;
    ...
    regaddr = (&((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->FTSR + (0x08u * offset));
    regval = *regaddr;
    ...
    *regaddr = regval;
    ...
    if ((pExtiConfig->Line & ((0x04uL << 24u) | (0x02uL << 24u))) == ((0x04uL << 24u) | (0x02uL << 24u)))
    {
      ...
      regval = ((SYSCFG_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000000UL))->EXTICR[linepos >> 2u];
      regval &= ~((0xFUL << (0U)) << ((4U) * (linepos & 0x03u)));
      regval |= (pExtiConfig->GPIOSel << ((4U) * (linepos & 0x03u)));
      ((SYSCFG_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000000UL))->EXTICR[linepos >> 2u] = regval;
    }
  }


  regaddr = (&((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->IMR + (0x08u * offset));
  regval = *regaddr;
  ...
  *regaddr = regval;
  ...
  regaddr = (&((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->EMR + (0x08u * offset));
  regval = *regaddr;
...
HAL_StatusTypeDef HAL_EXTI_GetConfigLine(EXTI_HandleTypeDef *hexti, EXTI_ConfigTypeDef *pExtiConfig)
{
  ...
  if ((hexti == 
# 274 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_exti.c" 3 4
               ((void *)0)
...
HAL_StatusTypeDef HAL_EXTI_ClearConfigLine(EXTI_HandleTypeDef *hexti)
{
  ...
  if (hexti == 
# 377 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_exti.c" 3 4
              ((void *)0)
# 377 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_exti.c"
                  )
  {
    return HAL_ERROR;
  }
...
# 433 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_exti.c"
HAL_StatusTypeDef HAL_EXTI_RegisterCallback(EXTI_HandleTypeDef *hexti, EXTI_CallbackIDTypeDef CallbackID, void (*pPendingCbfn)(void))
{
...
HAL_StatusTypeDef HAL_EXTI_GetHandle(EXTI_HandleTypeDef *hexti, uint32_t ExtiLine)
{
  ...
  if (hexti == 
# 464 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_exti.c" 3 4
              ((void *)0)
...
void HAL_EXTI_IRQHandler(EXTI_HandleTypeDef *hexti)
{
  ...
  regaddr = (&((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->PR + (0x08u * offset));
  regval = (*regaddr & maskline);
...
# 519 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_exti.c" 3 4
                                 ((void *)0)
# 519 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_exti.c"
                                     )
    {
...
# 535 "Drivers/STM32F3xx_HAL_Driver/Src/stm32f3xx_hal_exti.c"
uint32_t HAL_EXTI_GetPending(EXTI_HandleTypeDef *hexti, uint32_t Edge)
{
  volatile uint32_t *regaddr;
  uint32_t regval;
...
void HAL_EXTI_GenerateSWI(EXTI_HandleTypeDef *hexti)
{
  ...
  regaddr = (&((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x00000400UL))->SWIER + (0x08u * offset));
  *regaddr = maskline;
}
