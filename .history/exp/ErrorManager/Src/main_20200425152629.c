...
/* USER CODE BEGIN PFP */
void StartComUSBTask(void const * argument);
/* USER CODE END PFP */
...
int main(void)
{
  ...
  /* add threads, ... */
  osThreadDef(comUSBTask, StartUSBComTask, osPriorityAboveNormal, 0, 4096);
  comUSBTaskHandle = osThreadCreate(osThread(comUSBTask), NULL);
...
/* USER CODE BEGIN 4 */
void StartUSBComTask(void const * argument)
{
