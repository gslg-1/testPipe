...
./exec/tools/cpachecker/scripts/cpa.sh -valueAnalysis-NoCegar-join -outputpath ./output/CPAchecker -setprop analysis.checkCounterexamples=false -setprop solver.solver=SMTInterpol -setprop cpa.predicate.encodeBitvectorAs=INTEGER -setprop cpa.predicate.encodeFloatAs=RATIONAL ./output/prebuild/example1.p.c
